...
public class UserController {
   ...
   public ResponseEntity<ApiResponseMessage> deleteUser(@PathVariable String userId){
    ...
    public ResponseEntity<PageableResponse<UserDto>> getAllUser(
      ...
      @RequestParam(value = "ascDir",defaultValue = "asc",required = false) String ascDir
    ){
        return  new ResponseEntity<>(userService.getAllUser(pageNumber,pageSize,sortBy,ascDir),HttpStatus.OK);
    }
